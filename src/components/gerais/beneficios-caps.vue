<template lang="html">
  <section class="famososRecomendam mob">
        ...
        <div class="col-12 noPaddingMob">
          <div class="famososRecomendam-sliderContainer">
            <div class="famososRecomendam-sliderContainer-slider" ref="famososRecomendamSlider">
              <div v-for="(famoso, i) in capsBene" :key="i">
...
export default {
  ...
  computed: {
    ...mapState({
      ...
      capsBene: state => state.capsBene.capsBene
    })
  },
  created() {
    const interval = setInterval(() => {
      if (this.$refs.famososRecomendamSlider && this.$refs.famososRecomendamSlider.childElementCount == this.capsBene.length) {
        tns({
