<template lang="html">
  <skeletonMainMenu class="menuSkeleton" v-if="!menuLoaded && this.$store.state.screenWidth > 1023" />
  <header v-else class="cabecalhoHomem" >
    <vendaInterna
    :dados="dadosUser"
    ...
    <div class="container">
      <div class="row align-center ">
        <div class="col-12 headerContainerTop">
          ...
          <div class="headerContainerTop-logo" v-if="screenWidth > 1023">
            <router-link :to="{ name: 'home', params: {} }">
              <img :src="require('@/assets/img/geral/logo-masculino.png')" alt="">
            </router-link>
          </div>
          <div class="headerContainerTop-logo" v-else>
            <router-link :to="{ name: 'home', params: {} }">
              <img :src="require('@/assets/img/geral/logo-masculino-mob.png')" alt="">
            </router-link>
          </div>
          ...
          <div class="headerContainerTop-buscaContainer" >
            <div class="headerContainerTop-buscaContainer-top">
              ...
              <div class="headerContainerTop-carrinho">
                <a :href="`${$siteUrl}/checkout/carrinho/`">
...
<style>
header.cabecalhoHomem .headerContainerTop-menu,
header.cabecalhoHomem .mainMenu-container > .mainMenu-item {
  color: #000;
}
@media (max-width: 767px) {
  header.cabecalhoHomem .headerContainerTop-menu {
  ...
  header.cabecalhoHomem .headerContainerTop-buscaContainer-top svg {
    fill: #fff !important;
  }
}
</style>
