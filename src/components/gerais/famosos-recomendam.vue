<template lang="html">
  <section class="famososRecomendam">
    ...
    <div class="container">
      <div class="row">
        <div class="col-12" v-if="!rmTitle">
          <h1 class="famososRecomendam-t1">
            FAMOSOS QUE <br v-if="screenWidth <= 767 && screenWidth >= 340"> USAM E RECOMENDAM
          </h1>
          <p class="famososRecomendam-t2">Nosso time de celebridades <br v-if="screenWidth <= 767 && screenWidth >= 340"> que usam e amam o NH</p>
        </div>
        <div class="col-12 noPaddingMob">
          <div class="famososRecomendam-sliderContainer">
            <div class="famososRecomendam-sliderContainer-slider" ref="famososRecomendamSlider">
              <div v-for="(famoso, i) in famosos" :key="i">
                <div class="famososRecomendam-sliderContainer-slider-item">
                  <div class="famososRecomendam-sliderContainer-slider-item-img">
                    ...
                    <i class="famososRecomendam-sliderContainer-slider-item-img-play" @click="openVideo(famoso.video)"></i>
                  </div>
                  <div class="famososRecomendam-sliderContainer-slider-item-text">
                    <b class="famososRecomendam-sliderContainer-slider-item-text-t1">{{ famoso.nome }}</b>
                    <p class="famososRecomendam-sliderContainer-slider-item-text-t2">{{ famoso.profissao }}</p>
                  </div>
                </div>
              </div>
            </div>
...
export default {
  ...
  computed: {
    ...mapState({
      ...
      famosos: state => state.famosos.famosos
    })
  },
  created() {
    const interval = setInterval(() => {
      if (this.$refs.famososRecomendamSlider && this.$refs.famososRecomendamSlider.childElementCount == this.famosos.length) {
        tns({
