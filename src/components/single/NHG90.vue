                ...
                <div class="row" style="max-width:100%;">
                    <div class="col-sm-8">
                        <div class="imgMob mob" style="width:100%;">
                            <img src='@/assets/img/03_NEW_HAIR_GUMMIES.jpg' alt="">
                        </div>
                        <div class="imgMob mob1" style="width:100%;">
                            <img src='@/assets/img/03_NEW_HAIR_GUMMIES_MASSAGEADOR_MOB.jpg' alt="">
                        </div>                        
                    </div>
                    <div class="col-sm-4" style="margin-top:30px;">
                        <div class="col-sm-12" style="margin-top:20px;">
                            <h1 style="margin-bottom:20px;line-height:55px;">New Hair Gummies<br/><span style="font-size:25px;margin-left:3px;">+ Massageador</span><br/><span style="font-size:30px;margin-left:3px;">Tratamento de 90 Dias</span></h1>
                            ...
                            <div class="precos_alt">
                                <p style="color:#6b6b6b;font-size:20px;display:inline;margin:0px 20px"><s>De: R$ 449,70</s></p>
                                <p style="font-weight:bold;color:#000;font-size:20px;display:inline;margin:0px 20px;">Por: R$ 279,90</p>
                                <img class="my-3" src="@/assets/img/img-ou.png" alt="" style="display:block;margin:0 auto;">
                                <p style="color:#000;font-size:30px;text-align:center;">12x de <strong>R$ 23,32</strong> sem juros</p>
                            </div>
